...
/**
 * 이 도메인의 OpenAPI 그룹 — `/v3/api-docs/fulfillment`.
 *
 ...
 */
@Configuration
class FulfillmentOpenApiConfig {

    @Bean
    fun fulfillmentOpenApiGroup(): GroupedOpenApi = GroupedOpenApi.builder()
        .group("fulfillment")
        .packagesToScan("com.kgd.fulfillment")
        .addOpenApiCustomizer { openApi ->
            openApi.info(Info().title("Fulfillment Service API").description("출고 상태 관리 API").version("1.0.0"))
        }
        .build()
}
