...
| 작업 | msa 적용 위치 | 예시 |
|---|---|---|
| Visitor ID 쿠키 발급 | gateway `VisitorIdFilter` (`GlobalFilter`) | [`VisitorIdFilter.kt`](file:///Users/gideok-kwon/IdeaProjects/msa/gateway/src/main/kotlin/com/kgd/gateway/filter/VisitorIdFilter.kt) |
| 요청 로깅(method/uri/status/duration) | gateway `RequestLoggingFilter` | [`RequestLoggingFilter.kt`](file:///Users/gideok-kwon/IdeaProjects/msa/gateway/src/main/kotlin/com/kgd/gateway/filter/RequestLoggingFilter.kt) |
| JWT 검증 + 블랙리스트 | gateway `AuthenticationGatewayFilter` | [`AuthenticationGatewayFilter.kt`](file:///Users/gideok-kwon/IdeaProjects/msa/gateway/src/main/kotlin/com/kgd/gateway/filter/AuthenticationGatewayFilter.kt) |
