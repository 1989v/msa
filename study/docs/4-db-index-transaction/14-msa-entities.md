...
이번 학습 시점 (2026-05-01) 의 스냅샷이며, 일부 서비스는 Hibernate DDL auto-create 로 운영하고 있어 SQL 직접 정의가 없을 수 있음을 명시한다.
...
특징:
- 비즈니스 룰 (1인 1 SSO 매핑, 위시리스트 중복 방지) 을 DB 단으로 강제.
...
- ADR-0012 의 idempotent consumer 패턴.
