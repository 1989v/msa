...
> 묶음 1 (B) 약점 정조준. "refresh / flush / commit 의 차이" 는 시니어 검색 면접에서 가장 자주 나오는 질문이고, 운영 중 "왜 색인했는데 검색이 안 되지?" / "왜 ES (Elasticsearch) 가 갑자기 IO (Input/Output, 입출력) 폭증?" 같은 사고의 95% 가 여기서 옴.
