...
> 2PC 는 면접에서 "왜 안 쓰나" 를 묻는 패턴 질문. 답은 **blocking + coordinator SPoF + 성능** 세 가지.
...
- AZ 간 통신이라면 수십 ms × 2 round = 100ms+
...
- → **MSA 에선 거의 사용 안 함**. msa 프로젝트에서도 사용 안 함.
