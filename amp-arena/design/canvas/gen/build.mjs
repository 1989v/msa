// 아트보드 13장 + canvas.json 을 design/canvas/ 에 쓴다.  실행: node design/canvas/gen/build.mjs
import { writeFileSync, mkdirSync } from 'node:fs';
import { dirname, resolve } from 'node:path';
import { fileURLToPath } from 'node:url';
import { titleBoard, lobbyBoard, roomBoard, ingameBoard, resultBoard } from './boards/screens.mjs';
import { characterBoard, accessoriesBoard, movesBoard } from './boards/sheets.mjs';
import { mapColosseumBoard, mapSkyDockBoard, controlsBoard, netcodeBoard, roadmapBoard } from './boards/systems.mjs';
...
const BOARDS = [
  ...
  ['MapColosseum.dc.html', mapColosseumBoard, 1200, 760, '맵 1 콜로세움'],
...
const rows = [
  ...
  ['Character.dc.html', 'Accessories.dc.html', 'Moves.dc.html'],
  ['MapColosseum.dc.html', 'MapSkyDock.dc.html', 'Controls.dc.html', 'Netcode.dc.html', 'Roadmap.dc.html'],
];
