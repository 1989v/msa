...
export const MOVES = {
  // 파이터 (맨손 기본)
  jab: def({ id: 'jab', startup: 6, active: 3, recovery: 13, damage: 5, reach: 1.35, radius: 0.55, effect: 'hitstun', hitstun: 14, push: 1.5 }),
  straight: def({ id: 'straight', startup: 7, active: 3, recovery: 15, damage: 6, reach: 1.45, radius: 0.55, effect: 'hitstun', hitstun: 16, push: 2 }),
  ...
  // 스피드스타
  quick1: def({ id: 'quick1', startup: 4, active: 2, recovery: 9, damage: 3, reach: 1.3, radius: 0.5, effect: 'hitstun', hitstun: 12, push: 1 }),
  quick2: def({ id: 'quick2', startup: 4, active: 2, recovery: 9, damage: 3, reach: 1.3, radius: 0.5, effect: 'hitstun', hitstun: 12, push: 1 }),
  quick3: def({ id: 'quick3', startup: 5, active: 2, recovery: 10, damage: 4, reach: 1.35, radius: 0.5, effect: 'hitstun', hitstun: 14, push: 1.5 }),
  ...
  // 브레이커 (대검)
  gs1: def({ id: 'gs1', startup: 11, active: 4, recovery: 18, damage: 12, reach: 1.85, radius: 0.9, effect: 'hitstun', hitstun: 20, push: 3, arcDeg: 150 }),
  ...
  // 스파이크 (장창)
  sp1: def({ id: 'sp1', startup: 7, active: 3, recovery: 13, damage: 6, reach: 2.15, radius: 0.45, effect: 'hitstun', hitstun: 14, push: 2, arcDeg: 30 }),
  sp2: def({ id: 'sp2', startup: 7, active: 3, recovery: 13, damage: 6, reach: 2.15, radius: 0.45, effect: 'hitstun', hitstun: 16, push: 2, arcDeg: 30 }),
  ...
  // 월 (방패)
  shieldBash: def({ id: 'shieldBash', startup: 8, active: 3, recovery: 15, damage: 8, reach: 1.25, radius: 0.6, effect: 'hitstun', hitstun: 16, push: 3 }),
  ...
  haymaker: def({ id: 'haymaker', startup: 14, active: 4, recovery: 26, damage: 14, reach: 1.5, radius: 0.7, effect: 'launch', launchH: 7, launchV: 7 }),
  ...
  gsSweep: def({ id: 'gsSweep', startup: 10, active: 4, recovery: 18, damage: 11, reach: 1.85, radius: 0.9, effect: 'hitstun', hitstun: 20, push: 3, arcDeg: 170 }),
  gsOverhead: def({ id: 'gsOverhead', startup: 16, active: 5, recovery: 30, damage: 20, reach: 1.9, radius: 0.9, effect: 'launch', launchH: 5, launchV: 9, arcDeg: 90 }),
  ...
  gunBurst: def({ id: 'gunBurst', startup: 5, active: 1, recovery: 18, damage: 4, reach: 0, radius: 0, effect: 'hitstun', hitstun: 8, push: 1 }),
  shieldJab: def({ id: 'shieldJab', startup: 6, active: 3, recovery: 12, damage: 6, reach: 1.2, radius: 0.55, effect: 'hitstun', hitstun: 14, push: 2 }),
  shieldSlam: def({ id: 'shieldSlam', startup: 13, active: 4, recovery: 24, damage: 13, reach: 1.3, radius: 0.7, effect: 'launch', launchH: 7, launchV: 6 }),
  rkHeavy: def({ id: 'rkHeavy', startup: 14, active: 5, recovery: 26, damage: 15, reach: 2.0, radius: 0.7, effect: 'launch', launchH: 7, launchV: 7 }),
  ...
  // 더블탭 (쌍권총) — 실제 판정은 투사체
  gunShot: def({ id: 'gunShot', startup: 4, active: 1, recovery: 10, damage: 4, reach: 0, radius: 0, effect: 'hitstun', hitstun: 8, push: 1 }),
