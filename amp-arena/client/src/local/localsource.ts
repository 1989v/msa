...
export interface LocalOptions { name: string; acc: AccessoryId; style: StyleId; mapId: MapId; modeId: ModeId; seconds: number; bots: number; stats?: Partial<Stats>; skin?: Skin }
...
export class LocalSource implements MatchSource {
  ...
  constructor(o: LocalOptions) {
    ...
    this.roster.push({ id: 0, name: me.name, team: me.team, acc: o.acc, style: o.style, bot: false, stats: o.stats, skin: o.skin });
