...
const ACC_DESC: Record<AccessoryId, string> = {
  ...
  pistols: '약공은 총열로 후려치는 근접 2단. 강공은 두 줄 2연발(사거리 5m, 경직 약함). 탄 12발, 재장전 1.5초. 기술 V: 뒤로 구르며 부채꼴 6발.',
  shield: '방패 밀치기(넉백). 기술 V: 가드 유지 돌진. 가드 크러시 면역.',
  rocket: '펀치 리치 +0.4m. 기술 V: 로켓 펀치 발사(10m). 공중 대시 1회.',
  knuckle: '제일 빠른 2단 주먹(리치 짧음). 기술 V: 전진 연타 러시 5회.',
  chain: '사슬추 — 리치 2.1m, 넓은 호로 여럿을 훑는다. 기술 V: 360° 회전 다단(관통). 이동 −5%, 잡기 불가.',
  claw: '짧고 아주 빠른 2연격. 기술 V: 3.4m 갈고리로 상대를 끌어온다.',
  anchor: '제일 무거운 2단, 강공은 슈퍼아머. 기술 V: 내려찍기(가드 무시). 이동 −15%, 잡기 불가.',
  dagger: '단검 3단 — 제일 빠르고 한 대는 제일 약하다. 기술 V: 관통 대시 베기. 공중 대시 1회.',
  chakram: '던지는 원반 7발, 사거리 12m — 더블탭보다 느리고 탄이 크다. 기술 V: 부채꼴 5발.',
  hammer: '느린 2단, 강공이 가드를 부순다. 기술 V: 360° 충격파. 이동 −15%, 잡기 불가.',
  cannon: '포탄 5발, 사거리 15m·반경 0.55m(제일 큼). 재장전 2.3초. 기술 V: 3발 포격. 이동 −10%, 잡기 불가.',
  staff: '장봉 3단, 리치 2.0m. 기술 V: 봉을 짚고 도는 360° 발차기.',
  nunchaku: '쌍절곤 3단 연타. 기술 V: 제자리 회전 연타 5회.',
};
