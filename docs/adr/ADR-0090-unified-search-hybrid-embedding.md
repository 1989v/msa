...
## Status
**Accepted (2026-09-06) · D5 개정 (2026-09-07)** — 모델은 **`Qwen/Qwen3-Embedding-4B`**(1024차원으로 절단). 전 코퍼스 nDCG@10 0.7764 로 후보 7종 중 최고.
...
**D5. 모델은 `Qwen/Qwen3-Embedding-4B`** (4B · native 2560 → **MRL 로 1024 절단** · Apache-2.0 · Alibaba 공식).
판정 세트 1,121건(사람 113 + LLM 초안 1,008)에서 **전 코퍼스 nDCG@10 0.7764**, BM25(0.6802) 대비 +0.096. 후보 7종 중 1위.
...
| 모델 | 벡터 단독 | 하이브리드(RRF) | 델타 |
|---|---|---|---|
| BM25 (운영 현재) | 0.6802 | — | — |
| **Qwen3-Embedding-4B** | **0.7764** | **0.7343** | **+0.0541** |
| snowflake-arctic-embed-l-v2.0-ko | 0.7313 | 0.7199 | +0.0397 |
| harrier-oss-v1-270m | 0.7127 | 0.7137 | +0.0335 |
| multilingual-e5-small | 0.7018 | 0.7119 | +0.0317 |
| Snowflake/arctic-embed-l-v2.0 (공식) | 0.6928 | 0.6938 | +0.0136 |
| BAAI/bge-m3 | 0.6568 | 0.6894 | +0.0092 |
