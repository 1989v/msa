...
구현은 **9개 그룹 / 24개 실행 단위**로 나뉩니다. T02B는 한도에 맞춰 [4개 소단위](planning/t02b-small-steps.md)로 세분화했습니다. 다음은 **T02B-3b: 얼굴·헤어·옷 아트 보완**입니다.
[주인공 모델 스튜디오](implementation/t02b/character/README.md)와 [실제 캡처·검수](verifications/t02b-3.md)를 저장했습니다. 캐릭터 화면은 로컬 서버의 `implementation/t02b/character/index.html`에서 볼 수 있습니다. 장면은 로컬 서버에서
