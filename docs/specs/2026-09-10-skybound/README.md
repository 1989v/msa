...
구현은 **9개 그룹 / 24개 실행 단위**로 나뉩니다. T02B는 한도에 맞춰 [4개 소단위](planning/t02b-small-steps.md)로 세분화했습니다. 다음은 **T03A-4: 전용 활공 자세·손 접촉**입니다.
...
[최신 활공 검증](verifications/t03a-3.md) — 단위12/12, 브라우저12+19 통과.
