...
T03A-2 활공·이동 코어는 검사26/26을 통과했으며, T03A-3 진단 돛과 데모 활공도 활성화했다. T03A-4 양팔·손 접촉을 보완했으며 T03B-1 기류 하나를 연결했으며 T03B-2a 첫 공중 착지대를 추가했으며 T03B-2b 두 착지점 이동 경로를 검증했으며 T04A-1 순수 조작 규칙7/7을 검증했으며 T04A-2a 데모 선택·운반 연결11/11도 검증했다. 다음은 배치 지지·장애물 경계 검증이다. 활공·퍼즐·전투와 최종 아트/게임/배포는 미완료다.
