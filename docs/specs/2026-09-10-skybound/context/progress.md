...
**T03A-3 데모 활공 활성화·기술 돛 저장. 다음 T03A-4 전용 활공 자세·손 접촉.**
traversal 단위12/12, 활공 브라우저12/12·기존 이동19/19 통과. `verifications/t03a-3.md`.
Space 점프 후 공중 재누름으로 돛을 펼친다. 기류는 아직 배치하지 않았다.
기존 fall 포즈 임시 사용으로 손이 횡봉에 닿지 않는다. 아트 REVISE 유지.
...
3. **T03A-4**: `verifications/t03a-3.md`와 traversal README를 읽고 전용 활공 자세·손 횡봉 접촉을 보완한다.
   데모 활공은 활성화했다. 터치 공중 재누름도 실제 브라우저에서 확인한다. 이후 T03B 기류·공중 경로.
