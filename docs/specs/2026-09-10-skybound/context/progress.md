...
- **T02B-3b 얼굴·헤어·튜닉 보완 저장. 다음 T02B-3c 스카프/스트랩 접촉부 검토. 캐릭터의 게임 연결 전.**
- `implementation/t02b/character/`: 원본 모델/atlas, 두 LOD GLB, 뷰어, 모델 테스트 저장.
  수정 후 단위 5/5, 확대 포함 실제 GLB 브라우저 검사 30/30. 최종 아트 통과가 아니다.
  LOD0 14,936tri / LOD1 4,986tri, 19 bones, 1K atlas. 재빌드 1초 미만, 브라우저 재생성 수초.
  내장 PNG 포함 GLB는 1,955,896 / 1,578,764 bytes. `verifications/t02b-3b.md`에 검증/미달 기록.
...
**T02B-3c: 스카프·스트랩 접촉부와 천 제작 방식을 검토하고 보완.**
