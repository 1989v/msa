...
- [ ] TG-15.0 **Complete**: E2E 통합 테스트 green + Readiness Checklist 모두 통과.
  - [ ] TG-15.1 `QuantPhase1E2ESpec` (Testcontainers 기반 MySQL + ClickHouse + Kafka) — 시나리오:
  ...
  - [ ] TG-15.4 Readiness Checklist 문서 `quant/docs/phase1-readiness.md`:
    - [ ] 모든 TG 완료
  ...
  - [ ] TG-15.5 릴리즈 노트 초안 `docs/specs/2026-04-24-quant-crypto-trading/phase1-release-notes.md` — 구현된 FR/NFR 목록 + 범위 밖 항목 + Phase 2 Preflight 후보(OQ-007/017/018)
