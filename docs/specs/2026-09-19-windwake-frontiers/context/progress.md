...
Current: expansion requirements/spec/contracts drafted; six-dimension review next. Implementation has not started. No blocking user decision. Preserve existing windwake deployment and all unrelated workspace changes.

Target:64× area, streamed neighborhoods,15+ skills/four abilities,12 regular enemy archetypes/eight regional bosses, waypoint network, crops/village/night defense, save migration, Chrome routes and public update.
