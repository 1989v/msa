...
import com.kgd.quant.application.live.usecase.ExecuteLiquidationUseCase
 ...
 */
@Component
class ExecuteLiquidationService : ExecuteLiquidationUseCase {

    @Suppress("UNUSED_PARAMETER")
    override suspend fun execute(tenantId: TenantId, strategyId: StrategyId) {
