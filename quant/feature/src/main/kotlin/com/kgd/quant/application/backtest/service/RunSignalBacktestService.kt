...
import com.kgd.quant.application.backtest.usecase.RunSignalBacktestUseCase
...
/** RunSignalBacktestService — [RunSignalBacktestUseCase] 구현. 시그널 평가 규칙은 인터페이스 문서 참조 */
@Component
class RunSignalBacktestService(
    ...
    override suspend fun execute(
        ...
        to: Instant,
        interval: String,
    ): RunSignalBacktestUseCase.SignalBacktestSummary {
        ...
        return RunSignalBacktestUseCase.SignalBacktestSummary(
    ...
    companion object {
        private val EMPTY = RunSignalBacktestUseCase.SignalBacktestSummary(
            strategyId = "",
            from = Instant.EPOCH,
            to = Instant.EPOCH,
            barCount = 0,
