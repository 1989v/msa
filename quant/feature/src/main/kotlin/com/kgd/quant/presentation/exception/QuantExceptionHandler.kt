...
import com.kgd.quant.domain.exception.LeverageAttemptException
...
class QuantExceptionHandler {
    ...
    fun handleConfigInvalid(
        e: TrancheStrategyConfigInvalidException
