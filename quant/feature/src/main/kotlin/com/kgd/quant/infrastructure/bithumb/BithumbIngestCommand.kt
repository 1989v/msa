package com.kgd.quant.infrastructure.bithumb

import com.kgd.quant.infrastructure.clickhouse.ClickHouseConfig
import com.kgd.quant.infrastructure.ingest.FileIngestCheckpointStore
import com.kgd.quant.infrastructure.ingest.IngestCheckpointStore
import com.kgd.quant.infrastructure.ingest.IngestDlqRecorder
 ...
 * 실행 예:
 * ```
 * ./gradlew :quant:app:bootRun --args='--spring.profiles.active=ingest-bithumb --interval=1m'
 * ./gradlew :quant:app:bootRun --args='--spring.profiles.active=ingest-bithumb --force-reingest=BTC,ETH'
 * ```
 *
 * 지원 옵션:
