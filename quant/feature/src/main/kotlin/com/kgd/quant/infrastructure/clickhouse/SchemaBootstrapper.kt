...
/**
 * TG-06: quant DDL 을 classpath 에서 버전 순으로 읽어 JDBC Connection 에 적용한다.
 *
...
class SchemaBootstrapper {
    ...
    fun ddlResourcePaths(): List<String> = listOf(
        "/clickhouse/quant/V001__create_database.sql",
        "/clickhouse/quant/V002__market_tick_bithumb.sql",
        "/clickhouse/quant/V003__backtest_run.sql",
        "/clickhouse/quant/V004__execution_result_placeholder.sql",
    )
