...
class TrancheStrategyMapper(private val objectMapper: ObjectMapper) {
    ...
    fun toDomain(entity: TrancheStrategyEntity): TrancheStrategy {
        ...
        return TrancheStrategy.reconstruct(
