package com.kgd.quant.application.service
...
class StrategyRunPersistenceService(
    ...
    /**
     * 백테스트용 `StrategyRun` + `TrancheSlot` N 개를 DB 에 영속화.
     *
    ...
    suspend fun initializeRun(
        ...
        startedAt: Instant,
        seed: Long
    ): Pair<StrategyRun, MutableList<TrancheSlot>> {
        ...
        val slots = mutableListOf<TrancheSlot>()
