...
import com.kgd.quant.application.exception.BacktestRunNotFoundException
...
import com.kgd.quant.application.backtest.dto.BacktestRunDetailView
import com.kgd.quant.application.backtest.dto.BacktestRunSummaryView
import com.kgd.quant.application.backtest.dto.OrderView
import com.kgd.quant.application.backtest.dto.SlotView
 ...
 *  4. `TrancheSlotRepositoryPort.findByRunId` + 각 slot 의 Order 조회.
 *
 * ## 트랜잭션
