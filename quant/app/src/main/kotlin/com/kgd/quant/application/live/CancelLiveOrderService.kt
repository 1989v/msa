...
/**
 * CancelLiveOrderService — 사용자 수동 주문 취소 (ADR-0037 / TG-P3-27).
 *
 * 흐름:
...
) : CancelLiveOrderUseCase {
    override suspend fun execute(tenantId: TenantId, orderId: OrderId, exchange: Exchange): LiveOrderRecord {
