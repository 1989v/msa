package com.kgd.quant.application.strategy.dto
 ...
 * Repository 메타데이터로 채워 주입한다. 실 서비스에서는 `TrancheStrategyEntity.createdAt` 을
...
data class StrategyDetailView(
    ...
    companion object {
        fun from(strategy: TrancheStrategy, createdAt: Instant? = null): StrategyDetailView =
            StrategyDetailView(
