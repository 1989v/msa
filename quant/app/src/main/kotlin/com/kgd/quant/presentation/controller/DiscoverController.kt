...
class DiscoverController(
    private val ranking: GetMarketRankingUseCase,
    private val globalIndices: GetGlobalIndicesUseCase,
) {
    ...
    suspend fun topVolume(
        ...
        ApiResponse.success(ranking.rank(RankingMode.TURNOVER, market, limit))
    ...
    suspend fun topGainers(
        ...
        ApiResponse.success(ranking.rank(RankingMode.GAINERS, market, limit))
    ...
    suspend fun topLosers(
        ...
        ApiResponse.success(ranking.rank(RankingMode.LOSERS, market, limit))

    @GetMapping("/global-indices")
    suspend fun globalIndices(): ApiResponse<List<GlobalIndexQuote>> =
        ApiResponse.success(globalIndices.fetchAll())
}
