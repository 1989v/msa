...
/**
 * ADR-0029 Phase 1 (PR-2) — `ProcessedEventRepositoryPort` JPA 어댑터.
 *
 * 기존 quant 의 [ProcessedEventEntity] / [ProcessedEventJpaRepository] (BINARY(16) UUID +
 ...
 * - [deleteOlderThan] : 7일 retention 스케줄러용. quant 은 PR-2 시점에 cleanup 을 enable 하지
 *                       않지만 Port contract 를 충족하기 위해 구현한다.
 *
 * ## @Transactional
