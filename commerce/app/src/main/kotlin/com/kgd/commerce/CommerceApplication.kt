...
// ADR-0099: seller(마켓플레이스 판매자) — 전용 스키마 seller_db.
@SpringBootApplication(scanBasePackages = ["com.kgd.inventory", "com.kgd.warehouse", "com.kgd.fulfillment", "com.kgd.order", "com.kgd.product", "com.kgd.deal", "com.kgd.seller", "com.kgd.common.exception", "com.kgd.common.response"])
@EnableScheduling
