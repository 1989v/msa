...
assert.deepEqual(Object.keys(metadata.files).sort(), ['index.html','style.css','main.mjs','world.mjs','sim.mjs','render.mjs','audio.mjs','input.mjs','combat.mjs','progression.mjs','village.mjs','frontier-ui.mjs'].sort());
const assets = [];
