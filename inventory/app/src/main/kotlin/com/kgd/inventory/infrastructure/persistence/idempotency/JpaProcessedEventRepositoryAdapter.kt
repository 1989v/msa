 ...
 *
 * inventory 의 [ProcessedEventJpaEntity] / [ProcessedEventJpaRepository] (BINARY(16) UUID +
 * (event_id, consumer_group) 복합 PK 표준 스키마) 를 common 헬퍼가 사용 가능한 Port 로 노출한다.
 *
 * Phase 3 (PR-8) 에서 [com.kgd.inventory.infrastructure.messaging.InventoryEventConsumer] 가
