package com.kgd.inventory.domain.ownership.model

import java.time.Instant

/**
 * 재고 REST 소유 판정용 읽기 모델 — "이 상품은 어느 판매자 것인가". `product.item.*` 이벤트로 채운다.
...
/**
 * 재고 REST 소유 판정용 판매자 — "이 회원은 어느 판매자이고 지금 ACTIVE 인가". `seller.seller.*` 이벤트로 채운다.
