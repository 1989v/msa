...
import com.kgd.order.infrastructure.persistence.repository.OrderProcessedEventJpaRepository
 ...
 *
 * order 의 [ProcessedEventEntity] / [OrderProcessedEventJpaRepository] (BINARY(16) UUID +
 ...
 * 위임한다.
 */
@Component("orderProcessedEventRepositoryAdapter")
class JpaProcessedEventRepositoryAdapter(
    private val jpa: OrderProcessedEventJpaRepository,
