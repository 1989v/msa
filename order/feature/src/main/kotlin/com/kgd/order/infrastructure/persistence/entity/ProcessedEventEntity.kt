package com.kgd.order.infrastructure.persistence.entity
...
/**
 * ADR-0029 PR-3b — order 의 `processed_event` 테이블 매핑 Entity.
 *
 * ## 책임
 ...
 *
 * ## 참고
 * quant 의 [com.kgd.quant.infrastructure.persistence.entity.ProcessedEventEntity] 와 동일 구조.
 */
@Entity
