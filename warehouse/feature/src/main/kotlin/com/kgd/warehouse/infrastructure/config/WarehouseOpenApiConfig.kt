...
/**
 * 이 도메인의 OpenAPI 그룹 — `/v3/api-docs/warehouse`.
 *
 ...
 */
@Configuration
class WarehouseOpenApiConfig {

    @Bean
    fun warehouseOpenApiGroup(): GroupedOpenApi = GroupedOpenApi.builder()
        .group("warehouse")
        .packagesToScan("com.kgd.warehouse")
        .addOpenApiCustomizer { openApi ->
            openApi.info(Info().title("Warehouse Service API").description("창고 마스터 API").version("1.0.0"))
        }
        .build()
}
