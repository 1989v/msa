...
/**
 * ADR-0029 PR-7 — `ProcessedEventRepositoryPort` JPA 어댑터 (product).
 *
 * product 의 [ProcessedEventJpaEntity] / [ProcessedEventJpaRepository] (BINARY(16) UUID +
 ...
 * - [deleteOlderThan] : 7일 retention 스케줄러용. product 는 본 PR 시점에 cleanup 을 enable 하지
 *                       않으며 Port contract 충족만 한다.
 *
 * ## @Transactional
 ...
 *
 * ## 참고
 * quant / order / inventory 의 동명 Adapter 와 1:1 대응 패턴. 본 PR 시점에
 * [com.kgd.product.infrastructure.messaging.InventoryStockSyncConsumer] 가 같이 헬퍼로 wire-up 된다.
 */
@Component
