...
/**
 * CategoryChipStrip component tests.
 *
...
describe('CategoryChipStrip (code-dictionary)', () => {
  it('renders one chip per provided category plus the "전체" chip', () => {
    render(
      <CategoryChipStrip
  ...
  it('reflects selected state via aria-selected', () => {
    ...
    // when any category is selected, "전체" is not selected
