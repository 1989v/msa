...
} from '@admin/api/codeDictionary';
import type { Concept, IndexSyncJob } from '@admin/api/codeDictionary';
...
import TreemapSection from '@admin/components/codeDictionary/TreemapSection';
