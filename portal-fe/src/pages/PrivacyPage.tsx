          ...
          <article className="privacy-body">
            ...
            <section className="privacy-section">
              ...
              <table className="kh-table privacy-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>소셜 로그인</td>
                    <td>Google·Kakao 계정의 이메일과 프로필 이름</td>
                    <td>회원 식별</td>
                  </tr>
                  <tr>
                    <td>찜 · 평점 · 좋아요</td>
            ...
            <section className="privacy-section">
              ...
              <ul>
                ...
                <li>
                  <strong>조회 · 클릭 기록</strong> — 통계 목적으로 보관합니다. 개인을
                  식별할 수 있는 정보 없이 무작위 번호와 날짜만 남습니다.
                </li>
                <li>
                  <strong>이력서 열람 기록</strong> — 어떤 공유 링크가 언제 열렸는지만
                  남습니다. 열람한 사람을 식별하는 정보는 기록하지 않습니다.
                </li>
                <li>
