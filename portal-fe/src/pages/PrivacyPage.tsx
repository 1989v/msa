        ...
        <div className="privacy-inner">
          ...
          <article className="privacy-body">
            ...
            <section className="privacy-section">
              ...
              <table className="kh-table privacy-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>스토어 입점 신청(판매자)</td>
                    <td>
                      판매자 정보 — 상호, 사업자등록번호, 대표자명, 정산 은행·계좌번호, 배송비,
                      정산 주기
                    </td>
                    <td>입점 심사와 판매 대금 정산</td>
                  </tr>
                </tbody>
              </table>
              <p>
              ...
              <p>
                <strong>판매자의 정산 계좌번호는 암호화해 저장합니다.</strong> 화면과 관리
                도구에는 끝 4자리만 보이고, 원래 번호는 판매 대금을 보낼 때만 풀어 씁니다.
              </p>
            </section>
            ...
            <section className="privacy-section">
              ...
              <ul>
                ...
                <li>
                  <strong>광고 빈도 제한용 방문자 식별자</strong> — 같은 광고가 한 사람에게 너무 자주
                  나가지 않도록 방문자 번호를 해시로 바꿔 <strong>최대 25시간</strong> 보관하고, 그
                  뒤 자동으로 사라집니다. 광고 노출·클릭 이벤트 원장은 <strong>90일</strong> 보관 후
                  자동으로 삭제합니다. 자체 광고는 보고 있는 화면의 주제로만 고르며, 방문 기록으로
                  관심사를 추정하는 <strong>행태 타기팅은 하지 않습니다</strong>.
                </li>
                <li>
                ...
                <li>
                  ...
                  <strong>계정 저장을 켠 경우에만</strong> 서버에 보관하며, 끄면 그 즉시 파기합니다.
                  탈퇴할 때도 함께 파기합니다. 켜 둔 경우 <strong>마지막으로 사용한 날부터 1년</strong>
                  동안 쓰지 않으면 매주 도는 정리 작업이 자동으로 지웁니다. 별칭은 이용자가 직접
                  적는 값이라 실명이 들어올 수 있으므로 개인정보로 취급하며, 화면에서 별명 사용을
                  권합니다. 계정 저장을 켜지 않으면 명부는 기기에만 남고 서버로 보내지 않습니다.
                </li>
                <li>
                  <strong>판매자 정보</strong> — 입점 신청이 반려되면{' '}
                  <strong>반려일로부터 30일</strong> 뒤 매일 도는 정리 작업이
                  상호·사업자등록번호·대표자명·정산 계좌를 지웁니다. 신청 번호·상태·반려 사유와 그 시각만 남깁니다.
                  승인된 판매자의 정보는 정산이 이어지는 동안 보관합니다.
                </li>
                <li>
                  <strong>정산 기록</strong> — 판매 대금 정산 내역은 전자상거래법에 따라{' '}
                  <strong>5년</strong> 보관합니다.
                </li>
                <li>
