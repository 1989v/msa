...
/**
 * 이 도메인의 OpenAPI 그룹 — `/v3/api-docs/recommendation`.
 *
 ...
 */
@Configuration
class RecommendationOpenApiConfig {

    @Bean
    fun recommendationOpenApiGroup(): GroupedOpenApi = GroupedOpenApi.builder()
        .group("recommendation")
        .packagesToScan("com.kgd.recommendation")
        .addOpenApiCustomizer { openApi ->
            openApi.info(Info().title("Recommendation Service API").description("추천 API").version("1.0.0"))
        }
        .build()
}
