...
DAILY_LIMIT = {
    ...
    # 포털 화면은 상세기능별 100,000/일 로 적혀 있지만 **이 키가 실제로 받는 것은 하루 약 1,000건**이다
    # (detailIntro2 로 5,000 을 시도해 999건 뒤 전부 429, 2026-09-08). 화면 값과 실제가 달라
    # 어느 쪽도 상수로 박을 수 없다 — 429 를 수집기가 흡수하고 여기서는 관측만 한다.
    DATA_GO_KR: None,
}
