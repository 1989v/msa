...
| `nova-strike` | `portal-fe/public/games/nova-strike/` (**다중 파일**) | **클린룸 3호** (V32 시드). 32비트 세대 런앤건 액션 플랫포머 — 640×360 정수 배율, 리그 베이크 스프라이트+자동 외곽선/림라이트, 대시·월점프·차지 3단·보스 무기 3종 약점 순환, 4지역(용암 추격/빙판/상승기류/최종 2형태 보스) + 하트탱크·캡슐 숨김 + 코어 칩 상점. 한국어 UI 는 고해상 오버레이 캔버스. 통합은 `lib/platform.js`. 설계: `docs/specs/2026-08-15-nova-strike-design.md` |
